...
export declare class TasksService {
    ...
    constructor(taskRepository: TaskRepository, activityService: ActivityService);
    create(dto: CreateTaskDto, projectId: string, userId: string): Promise<Task>;
    findAll(projectId: string, filterDto: FilterTaskDto, dto: PaginationDto): Promise<PaginatedResult<any>>;
